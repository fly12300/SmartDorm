...
public class TemperatureMessageListener implements IMqttMessageListener {
    ...
    @Autowired
    public TemperatureMessageListener(RabbitTemplate rabbitTemplate, DormPoMapper dormPoMapper, AlarmPoMapper alarmPoMapper) {
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
            System.out.println("Temperature: " + mqttMessage.toString());
            // 处理温度消息
        try {
            ...
            if (dormPo.isPresent()) {
                ...
                po.setTemperature(sensorPo.getSensorData());
