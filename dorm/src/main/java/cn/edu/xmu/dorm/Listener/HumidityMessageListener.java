...
public class HumidityMessageListener implements IMqttMessageListener {
    ...
    @Autowired
    public HumidityMessageListener(RabbitTemplate rabbitTemplate, DormPoMapper dormPoMapper, AlarmPoMapper alarmPoMapper) {
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) throws Exception {
            System.out.println("Humidity: " + mqttMessage.toString());
            // 处理湿度
        try {
            ...
            if (dormPo.isPresent()) {
                ...
                po.setHumidity(sensorPo.getSensorData());
